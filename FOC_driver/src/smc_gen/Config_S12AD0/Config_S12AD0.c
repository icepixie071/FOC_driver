...
void R_Config_S12AD0_Create(void)
{
    ...
    S12AD.ADADC.BYTE = _01_AD_2_TIME_CONVERSION | _00_AD_ADDITION_MODE;
    ...
    S12AD.ADSHCR.WORD = _0100_AD_DSH_ANx00_SELECT | _0200_AD_DSH_ANx01_SELECT | _0400_AD_DSH_ANx02_SELECT | 
                        _0029_AD0_DSH_SAMPLING_STATE;

    /* Set AN000 amplifier */
    S12AD.ADPGADCR0.BIT.P000DEN = 0U;
    S12AD.ADPGAGS0.BIT.P000GAIN = _0008_AD_GAIN_5_000;
    S12AD.ADPGACR.BIT.P000CR = _000E_AD_PATH_Px_ANx_Px;

    /* Set AN001 amplifier */
    S12AD.ADPGADCR0.BIT.P001DEN = 0U;
    S12AD.ADPGAGS0.BIT.P001GAIN = _0008_AD_GAIN_5_000;
    S12AD.ADPGACR.BIT.P001CR = _000E_AD_PATH_Px_ANx_Px;

    /* Set AN002 amplifier */
    S12AD.ADPGADCR0.BIT.P002DEN = 0U;
    S12AD.ADPGAGS0.BIT.P002GAIN = _0008_AD_GAIN_5_000;
    S12AD.ADPGACR.BIT.P002CR = _000E_AD_PATH_Px_ANx_Px;

    /* Wait for stabilization of the PGA(s) */
    for (w_count = 0U; w_count < _0079_AD_PGA_STABLE_WAIT_COUNT; w_count++)
    {
        nop();
    }
